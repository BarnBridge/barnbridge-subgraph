...
import {Harvest as HarvestEventBond, MassHarvest as MassHarvestEventBond} from '../generated/YieldFarmBond/YieldFarmBond'
...
export function handleMassHarvestBond(event: MassHarvestEventBond): void {
    let id = event.transaction.hash.toHex() + "_" + event.transactionLogIndex.toString()
...
export function handleHarvestBond(event: HarvestEventBond): void {
    let id = event.transaction.hash.toHex() + "_" + event.transactionLogIndex.toString()
